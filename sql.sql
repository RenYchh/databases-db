...
insert into interface_api(api_name, file_name, r_url, r_method, p_type, status) values('用户注册','user_registration', 'http://39.106.41.11:8080/register/','post','form',1)
...
insert into interface_data_store values(2,1,'{"request.register.1.username":"cccs23","request.register.1.password":"sdfsdf23dd"}',"2018-07-27 12:21:20");